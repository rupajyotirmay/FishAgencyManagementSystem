...
rs.Open "select * from  sale where Date>=#" & DTPicker1.Value & "# and Date <=#" & DTPicker2.Value & "#", con, adOpenDynamic, adLockOptimistic, adCmdText
rowctr = 1
Do While rs.EOF = False
    ...
    Grid1.TextMatrix(rowctr, 3) = rs.Fields(7)
    Grid1.TextMatrix(rowctr, 4) = rs.Fields(8)
    Grid1.TextMatrix(rowctr, 5) = rs.Fields(7) - rs.Fields(8)
    rowctr = rowctr + 1
    rs.MoveNext
Loop
End Sub
