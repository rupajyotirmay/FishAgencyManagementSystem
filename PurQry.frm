...
rs.Open "select * from  Purchase where Date>=#" & DTPicker1.Value & "# and Date <=#" & DTPicker2.Value & "#", con, adOpenDynamic, adLockOptimistic, adCmdText
rowctr = 1
Do While rs.EOF = False
    ...
    Grid1.TextMatrix(rowctr, 3) = rs.Fields(4)
    Grid1.TextMatrix(rowctr, 4) = IIf(IsNull(rs.Fields(5)), " ", rs.Fields(5))
    Grid1.TextMatrix(rowctr, 5) = IIf(IsNull(rs.Fields(4) - rs.Fields(5)), " ", rs.Fields(4) - rs.Fields(5))
    rowctr = rowctr + 1
    rs.MoveNext
Loop
End Sub
